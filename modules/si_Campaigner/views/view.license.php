...
class ViewLicense extends SugarView
{
    ...
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
            ...
            translate('LBL_STACKIMAGINE_CAMPAIGNER', 'Administration') . ': ' . translate('LBL_STACKIMAGINE_CAMPAIGNER_LICENSE_TITLE', 'Administration'),
        );
    }
    ...
    public function display()
    {
        ...
        require_once('modules/' . $currentModule . '/license/si_CampaignerOutfittersLicense.php');
        ...
        $key = si_CampaignerOutfittersLicense::getKey($currentModule);
        ...
        if (isset($outfitters_config['manage_licensed_users']) && $outfitters_config['manage_licensed_users'] == true) {
            ...
            if (!empty($trimmed_last)) {
                ...
                $validated = si_CampaignerOutfittersLicense::doValidate($currentModule);
