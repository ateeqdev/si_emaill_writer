...
$dictionary['si_Campaigner'] = [
  ...
  'fields' => [
    ...
    'outboundemailaccounts_si_campaigner_1_name' => [
    ...
    'outboundemailaccounts_si_campaigner_1outboundemailaccounts_ida' => [
...
VardefManager::createVardef('si_Campaigner', 'si_Campaigner', array('basic', 'assignable', 'security_groups'));
