...
class SendEmailActionButton extends LegacyHandler implements ProcessHandlerInterface, LoggerAwareInterface
{
    protected const MSG_OPTIONS_NOT_FOUND = 'Process options are not defined';
    protected const MSG_INVALID_TYPE = 'Invalid type';
    public const PROCESS_TYPE = 'record-send-email';
    ...
    public function run(Process $process)
    {
        ...
        $result = HandleSending::send($options['id'], ucfirst($options['module']));
        // $result = json_decode($responseData)?? $responseData;
        $this->close();
        ...
        $process->setMessages(['Email Sent']);
